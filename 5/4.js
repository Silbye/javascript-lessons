...
function getAllWithImages(array) {
    const newArr = array.filter(
        (array) => "photos" in array && array.photos.length > 0
    );
    return newArr;
}

function sortArrayByPrice(array) {
    return array.sort((product1, product2) => product1.price - product2.price);
}

console.log(getAllWithImages(products));
console.log(sortArrayByPrice(products));